...
|Reflexive/Contract/Aspect |18
|`+rust-parser/tests/integration_tests.rs+` |✓ PASS

|Property-based tests |30 |`+rust-parser/tests/property_tests.rs+` |✓
PASS
...
* [x] *Smoke tests*: 5 smoke tests (trivial function, arithmetic, loop,
if-expr, let-binding)
* [x] *Build tests*: `+cargo build+` succeeds
* [x] *P2P (property-based)*: 30 proptest invariants in
`+property_tests.rs+`
...
* [x] *Aspect tests*: Security (malformed input), performance, error
handling
* [x] *Benchmarks*: 7 Criterion benchmark functions in
`+parser_bench.rs+`
