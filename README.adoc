...
:experimental:
:url-github: https://github.com/hyperpolymath/boinc-boinc
:url-gitlab: https://gitlab.com/hyperpolymath/boinc-boinc
:url-bitbucket: https://bitbucket.org/hyperpolymath/boinc-boinc
:url-codeberg: https://codeberg.org/hyperpolymath/boinc-boinc

BOINC distributed computing project integration
...
boinc-boinc is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
