...
image:{license-PMPL--1.0}[License,link=LICENSE.txt]
...
* link:LICENSE.txt[*Palimpsest-MPL License v1.0 (PMPL-1.0)*] - Permissive, allows commercial use
...
* *Palimpsest-MPL License v1.0 (PMPL-1.0)* for permissive use
* *PMPL-1.0-or-later* for copyleft projects (compatible option)
* *PMPL-1.0 + Palimpsest-0.8* for politically autonomous software (*philosophically encouraged*)
