...
Build a complete parser and analyzer for Oblibeny that can: 1. Parse
Oblibeny source code into AST 2. Separate compile-time and deploy-time
phases 3. Analyze resource usage and termination 4. Generate test
vectors for BOINC work units
...
. Build AST types
. Write parser
. Implement phase separator
. Build resource analyzer
. Add CLI
